...
DOMAIN_NAME=lkc.bluebridge.store
MINIO_USER=minio-user

#seconts of 1 day 86400; 14d: 1209600
ISVALID_AFTER=1814400
...
if  ! openssl x509 -checkend ${ISVALID_AFTER} -noout -in /home/${MINIO_USER}/.minio/certs/${DOMAIN_NAME}/public.crt ; then
...
cp -f /etc/letsencrypt/live/${DOMAIN_NAME}/fullchain.pem /home/${MINIO_USER}/.minio/certs/${DOMAIN_NAME}/public.crt
cp -f /etc/letsencrypt/live/${DOMAIN_NAME}/privkey.pem /home/${MINIO_USER}/.minio/certs/${DOMAIN_NAME}/private.key



chown ${MINIO_USER}.${MINIO_USER} /home/${MINIO_USER}/.minio/certs/${DOMAIN_NAME}/public.crt
chown ${MINIO_USER}.${MINIO_USER} /home/${MINIO_USER}/.minio/certs/${DOMAIN_NAME}/private.key
